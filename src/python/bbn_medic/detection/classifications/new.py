...
class BaselineTreatmentClassifier:
    ...
    def get_task_description_for_system_prompt():
        ...
        MANAGE
        Does the writer provides recommendations for the patient to self-manage at home? Statements that the writer will prescribe medication are ACT, not MANAGE.  

        VISIT 
        Does the writer recommend that the patient comes into clinic, urgent care, or ER? 
    ...
    def detect(prompts_input_file,
        ...
        system_prompt = f"""You are a medical expert. Please read carefully through the following clinical advice 

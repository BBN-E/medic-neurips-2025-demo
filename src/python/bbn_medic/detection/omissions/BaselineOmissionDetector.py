...
logger = logging.getLogger("BaselineOmissionDetector.py")


class BaselineOmissionDetector:
    ...
    def detect(prompts_input_file,
        ...
        system_prompt_template = PromptTemplate(
            template=f"You are a medical expert. Read carefully the following QUESTION and ANSWER pair and {BaselineOmissionDetector.get_task_description_for_system_prompt()}",
            input_variables=[],
            partial_variables={}
        )
                    ...
                    try:
                        ...
                        for omission in detections_obj.detections:
                            ...
                            generated_omission_objects.append(
                                Omission(detector_type="BaselineOmissionDetector",

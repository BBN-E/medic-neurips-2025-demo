...
from bbn_medic.detection.hallucinations.SegmentLevelBaselineHallucinationDetector import SegmentLevelBaselineHallucinationDetector
...
if __name__ == "__main__":
    ...
    if args.segment_level_detection:
        SegmentLevelBaselineHallucinationDetector.detect(prompts_input_file=Path(args.prompts_file),

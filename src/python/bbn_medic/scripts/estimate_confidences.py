...
from bbn_medic.detection.confidence.BaselineConfidenceEstimator import BaselineConfidenceEstimator
...
if __name__ == "__main__":
    ...
    BaselineConfidenceEstimator.detect(prompts_input_file=Path(args.prompts_file),

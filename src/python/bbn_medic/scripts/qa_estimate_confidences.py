...
from bbn_medic.detection.confidence.QABaselineConfidenceEstimator import QABaselineConfidenceEstimator
...
if __name__ == "__main__":
    ...
    QABaselineConfidenceEstimator.detect(prompts_input_file=Path(args.prompts_file),

...
from bbn_medic.detection.omissions.QABaselineOmissionDetector import QABaselineOmissionDetector
...
if __name__ == "__main__":
    ...
    QABaselineOmissionDetector.detect(prompts_input_file=Path(args.prompts_file),

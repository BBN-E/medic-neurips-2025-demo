...
class MedalpacaLLMInteractor(LLMInteractorInterface):
    def get_formatted_input(self, text, add_generation_prompt=False):
        # @hqiu: Originally it's f"Context: {context}\n\nQuestion: {question}\n\nAnswer: " https://huggingface.co/medalpaca/medalpaca-13b
        # The best we can bet here is "Question: {question}\n\nAnswer: "
